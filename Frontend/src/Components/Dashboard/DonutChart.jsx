  ...
  return (
    <div className="bg-white/60 backdrop-blur-md p-4 pr-0 rounded-2xl shadow">
      <h3 className="text-lg font-semibold mb-1">
        {project ? `${project.name} — Skills` : "Skills Breakdown"}
      </h3>
      <p className="text-xs text-gray-400 mb-3">
        {project ? "Skills required for this project" : "Aggregate across all projects"}
      </p>

      {data.length === 0 ? (
        <p className="text-sm text-gray-400 text-center py-6">No skill data available</p>
      ) : (
        <div className="grid grid-cols-2">
          ...
          <div className="text-center">
            <p className="text-gray-800 text-sm">Top Skills</p>
